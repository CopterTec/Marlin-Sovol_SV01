...
#define STRING_CONFIG_H_AUTHOR "CopterTec 1.3.8 SBBT" // Who made the changes.
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -34.5, -4, 0 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 4	//In this case: Nozzle to Probe dead zone	// Set Mesh bounds as an inset region of the bed
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_MANUAL  { 37, 40, 243, 215 }  // (mm) Manual position { X-front-left, Y-front-left, X-back-right, Y-back-right }
